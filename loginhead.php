...
?>
<form style="margin:0;float:right;padding:0;" action='' id='loghead' method='post'>
...
<small style='color:white;background:#07c;padding:5px;;border-radius:3px;font-size:small; cursor:pointer;' class='log'>Masuk</small>
<a href='./registrasi.aspx'><small style='color:white;background:#07c;padding:5px;;border-radius:3px;font-size:small; cursor:pointer;' class='log'>Registrasi</small></a>